...
namespace ShineEngine
{
    ...
    public class DateControl
    {
        ...
        public static void init()
        {
            ...
            try
            {
                TimeUtils.curTimeZone = TimeZoneInfo.FindSystemTimeZoneById(GlobalSetting.timeZone);
                TimeUtils.zoneOffset = (int)TimeUtils.curTimeZone.BaseUtcOffset.TotalMilliseconds;
            }
            catch(Exception e)
            {
                TimeUtils.curTimeZone = TimeZoneInfo.CreateCustomTimeZone(GlobalSetting.timeZone, new TimeSpan(TimeUtils.zoneOffset / 3600000, 0, 0), GlobalSetting.timeZone, GlobalSetting.timeZone);
            }
